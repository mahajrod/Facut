	...
	while ((rez=getopt_long(argc,argv,short_options, long_options,&option_index))!=-1)	\
		...
		switch(rez)	\
			...
			case 'h':	\
				...
				printf("    -n/--name_type            STR    Name type of reads in file. Possible variants: short, illumina, iontorrent, miseq, completegenomics\n"); \
			...
			case 'n':	\
				...
				if (strcmp(optarg,"completegenomics") == 0)	\
					{	\
					name_type = 6;	\
					break; \
					}	\
